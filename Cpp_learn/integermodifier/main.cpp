...
int main(){
   ...
   signed int value1 {10}; //accepts signs + - 
   signed int value2 {-300};

   std::cout << "value1: " << value1 << std::endl;
   std::cout << "Value2: " << value2 << std::endl;

   std::cout << "size of value1: " << sizeof(value1) << std::endl; // 4 bytes
   std::cout << "size of value2: " << sizeof(value2) << std::endl; // 4 bytes


    unsigned int value3 {4};
    //unsigned int value4 {-5}; //compiler error unsigned means only positive
