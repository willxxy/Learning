...
def repo_create(path):
    ...
    #First, make sure the path doesn't exist or is an empty dir
...
class GitObject(object):
    ...
    def serialize(self):
        """his function MUST be implemented by subclasses.
...
def object_write(obj, actually_write = True):
    ...
    #compute hash
    sha = haslib.shal(result).hexdigest()
...
def object_has(fd, fmt, repo = None):
    ...
    #Choose constructor depedning on object type found in header
...
def kvlm_parse(raw, start = 0, dct = None):
    ...
    #we assum a blank line. a blank line means the remainder of the data is the message
