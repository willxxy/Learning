...
\title{Transfer Learning in Histopathological Images of Lung Adenocarcinoma and Osteosarcoma}
\author{Yifei Liu, William Han \\ University of California, Irvine \\ \texttt{\{Yifei Liu, William Han\}yifeil23@uci.edu}
...
\begin{abstract}
Lung adenocarcinoma is the most frequently diagnosed lung cancer in the United States and osteosarcoma is one of the most common forms of cancers for children, adolescents, and young adults. Although the survivability and prognosis of osteosarcoma and adenocarcinoma is unique to everyone, early, immediate medical attention and aggressive therapy are known to be essential factors for a successful recovery. We present state of the art (SOTA) multi-class classification models utilizing convolutional neural networks to predict three classes {Adenocarcinoma: Invasive, In situ, and Normal, Osteosarcoma: Non-Tumor, Necrosis, and Viable Tumor} from whole slide images stained with hematoxylin and eosin. Performing transfer learning with popular architectures such as ResNet152, ResNet50, DenseNet201, InceptionV3, VGG19 and VGG16, and pretraining with the ImageNet database, we were able to achieve an average validation accuracy and loss of 95.85\% and 0.1725 respectively. ResNet50 outperformed all of the models with a validation accuracy and loss of 96.7\% and 0.09 on the osteosarcoma images, while {testing lung}.
